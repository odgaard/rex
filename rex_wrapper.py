...
def compress_files(current_files, index_name, group, prefix_bytes, prefix_format, parquet_dir):
    ...
    from rex import compress_logs
    compress_logs(current_files, index_name, group, prefix_bytes, prefix_format, parquet_dir)

def compact_indices(index_name, num_groups, split):
    raise RuntimeError("Compaction not implemented yet.")
